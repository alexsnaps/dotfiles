...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=color8 #${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-$thm_bg}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-$blue}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		"pomodoro $blue $thm_bg ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		"wan_ip $blue $thm_bg"
		#"vcs_branch $thm_gray"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"cpu 240 136"
		"load $blue $thm_bg"
		"tmux_mem_cpu_load $sky_blue $thm_bg"
		#"battery $blue $thm_bg"
		#"weather 37 255"
		...
		#"date_day 8 15"
		"date 8 15"
		"time 8 15 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
